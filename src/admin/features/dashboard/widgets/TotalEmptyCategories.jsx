...
const TotalEmptyCategories = memo(() => {
    ...
    return (
        <Card>
            <Row>
                <Col span={18}>
                    <Statistic title={__('Total Empty Categories', 'bulk-category-manager')} loading={false} value={10}/>
                </Col>
                <Col span={6}>
...
export default TotalEmptyCategories;